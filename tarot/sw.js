...
const CARD_URLS = ['./cards/ink/back.webp', ...KEYS.map(k => './cards/ink/' + k + '.webp')];
...
self.addEventListener('fetch', e => {
  ...
  const isPage = req.mode === 'navigate' || (req.headers.get('accept') || '').includes('text/html') || url.pathname.endsWith('.js');
  if (isPage) {
