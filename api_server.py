...
# ---- LINE OA ของ "รังกาแฟ" (ร้านจำลองคุมเอง — เดโม/เคสศึกษานกน้อยเปิดรัง, 23 ก.ค. 2026) ----
RANGKAFAE_LINE_CHANNEL_SECRET = os.environ.get("RANGKAFAE_LINE_CHANNEL_SECRET", "")
RANGKAFAE_LINE_CHANNEL_TOKEN  = os.environ.get("RANGKAFAE_LINE_CHANNEL_TOKEN", "")
...
SEO_PAGES = {
    "line-bot": {
        ...
        "kw": "รับทำ line bot, line oa, line messaging api, บอทไลน์, ไลน์บอทร้านค้า, "
              "จ้างทำ line bot ราคาถูก, line oa ตอบแชทอัตโนมัติ, บอทไลน์ร้านค้าออนไลน์, "
              "สร้างแชทบอท line, line bot สำหรับธุรกิจขนาดเล็ก",
...
""",
            ...
            {
                "h2": "📌 ไม่ใช่แค่ Mockup — มีระบบที่ใช้งานจริงอยู่ตอนนี้",
                "body": """
<p><strong>ระบบเดียวกันนี้กำลังตอบลูกค้าจริงอยู่</strong> บน Facebook Messenger ของร้านค้าออนไลน์
รายหนึ่งที่เราดูแลอยู่ — บอทตอบคำถามสินค้า ราคา โปรโมชั่น และที่อยู่ร้านให้ลูกค้าเองตลอด 24 ชม.
ไม่ต้องมีแอดมินเฝ้าตลอดเวลา</p>
<p>ทดสอบใช้งานจริงต่อเนื่องหลายรอบ ทั้งข้อความ รูปแผนที่ และโปรโมชั่นแบบยาว — ตอบถูกต้องทุกครั้ง
ตลอดการใช้งานจริง</p>
<div class="note">💡 เดโมที่ให้ลองเล่นด้านบนคือตัวอย่างระบบ ส่วนนี้คือหลักฐานว่าเราส่งระบบจริงให้ลูกค้าใช้งาน
ได้จริง ไม่ใช่แค่ทฤษฎี</div>
""",
            },
        ],
        "chat": [
        ...
        "faq": [
            ...
            ("ราคาถูกกว่าจ้างแอดมินเพิ่มไหม",
             "ถูกกว่ามากครับ จ้างแอดมินเพิ่ม 1 คนเริ่มต้นหลักหมื่นบาท/เดือน "
             "แต่ LINE Bot เริ่มแค่ ฿590/เดือน ทำงานได้ 24 ชม. ไม่ต้องพักไม่ต้องลา"),
            ("ธุรกิจขนาดเล็กมากๆ ใช้ได้ไหม",
             "ใช้ได้ครับ ไม่จำกัดขนาดธุรกิจ ร้านค้าเล็กๆ ที่มีคนเดียวดูแลทุกอย่าง "
             "ได้ประโยชน์มากที่สุดเพราะช่วยแบ่งเบาภาระตอบแชทได้จริง"),
            ("ต่างจากบริการตอบแชทอัตโนมัติทั่วไปยังไง",
             "บริการตอบแชทอัตโนมัติทั่วไปมักตอบตามคีย์เวิร์ดตายตัวเท่านั้น "
             "แต่ LINE Bot ของเราเข้าใจประโยคธรรมชาติ และเชื่อมกับระบบจองคิว/เก็บข้อมูลได้ในตัว"),
        ],
    },
    "line-bot-raka": {
        "h1": "LINE Bot ราคาเท่าไหร่",
        "title": "ราคา LINE Bot / LINE OA จ่ายเท่าไหร่ | เทียบครบทุกแพ็กเกจ เริ่ม ฿590/เดือน",
        "desc": "สรุปราคา LINE Bot ตรงไปตรงมา: รายเดือนเริ่ม ฿590 จ้างทำระบบเฉพาะ ฿5,000-30,000 "
                "พร้อมวิธีเลือกแพ็กเกจให้ตรงกับร้าน ไม่มีค่าติดตั้ง ไม่มีค่าแอบแฝง ลองฟรีก่อนจ่าย",
        "kw": "line bot ราคา, ราคา line bot, line oa ราคา, จ้างทำ line bot ราคาถูก, "
              "ทำ line bot ราคาเท่าไหร่, ราคาแชทบอท, chatbot ราคา, ค่าบริการ line oa, "
              "จ้างเขียนบอทไลน์ ราคา, line bot รายเดือน",
        "lead": "รวมราคาจริงทุกแบบไว้หน้าเดียว — รายเดือนเท่าไหร่ จ้างทำครั้งเดียวเท่าไหร่ และอะไรทำให้ราคาต่างกัน",
        "points": [
            ("💰", "รายเดือนเริ่ม ฿590 ไม่มีค่าติดตั้ง"),
            ("🧾", "ไม่มีค่าแอบแฝง ไม่มีสัญญาผูกมัด"),
            ("⚖️", "เทียบรายเดือน vs จ้างทำครั้งเดียวชัดๆ"),
            ("🎁", "ลองเดโมฟรีก่อนตัดสินใจทุกแพ็กเกจ"),
        ],
        "og_tagline": "เทียบราคาครบทุกแพ็กเกจ",
        "og_sub": "รายเดือน ฿590-2,900 · ระบบเฉพาะ ฿5,000-30,000 · ไม่มีค่าติดตั้ง",
        "plans_label": "ราคา",
        "price_line": "รายเดือนเริ่ม ฿590 · ระบบเฉพาะเริ่ม ฿5,000",
        "sections": [
            {
                "h2": "💳 ราคาแบบรายเดือน — จ่ายเบา เริ่มไว",
                "body": """
<p><strong>Starter ฿590/เดือน</strong> — บอทตอบแชทอัตโนมัติ ส่งข้อมูลสินค้า/บริการ ราคา
เวลาเปิด-ปิด เหมาะกับร้านที่อยากหยุดตอบคำถามซ้ำๆ ก่อน</p>

<p><strong>Pro ฿1,290/เดือน</strong> — เพิ่มระบบรับจองคิว/รับออเดอร์ในแชท พร้อมเก็บข้อมูลลูกค้า
เป็นระเบียบ ร้านส่วนใหญ่จบที่ตัวนี้เพราะคุ้มสุดเทียบราคา</p>

<p><strong>Business ฿2,900/เดือน</strong> — หลายสาขา หลายทีม แยกการจัดการได้
สำหรับธุรกิจที่โตแล้วต้องการระบบรวมศูนย์</p>

<div class="note">💡 ทุกแพ็กเกจรวมค่าดูแลระบบ + แก้คำตอบ/เพิ่มข้อมูลให้ฟรีตลอดอายุใช้งาน
ไม่มีค่าติดตั้ง ไม่มีสัญญาผูกมัด ยกเลิกได้ทุกเมื่อ</div>
""",
            },
            {
                "h2": "🧱 จ้างทำระบบเฉพาะครั้งเดียว ฿5,000-30,000",
                "body": """
<p>บางงานไม่ใช่บอทมาตรฐาน แต่เป็นระบบที่ออกแบบตามสโคปเฉพาะร้าน — แบบนี้คิดราคาครั้งเดียวจบ:</p>

<p><strong>เริ่ม ฿5,000</strong> — งาน automation ชิ้นเล็ก เช่น workflow n8n เชื่อมระบบที่ใช้อยู่
ให้ทำงานอัตโนมัติ 1 เรื่อง</p>

<p><strong>ราว ฿10,000</strong> — LINE Bot เริ่มต้นแบบสร้างเฉพาะ หรือบอทร้านค้าออนไลน์
ที่ต้องการ flow สั่งซื้อของตัวเอง</p>

<p><strong>ถึง ฿30,000</strong> — ระบบใหญ่ เช่น ระบบบันทึกข้อมูลคนไข้สำหรับคลินิก
หรือเว็บแอปพลิเคชันที่ทำงานคู่กับบอท</p>

<div class="note">💡 ไม่แน่ใจว่างานของคุณอยู่ช่วงไหน ทักมาเล่าสโคปก่อนได้
ประเมินราคาให้ฟรี ไม่มีข้อผูกมัด</div>
""",
            },
            {
                "h2": "⚖️ อะไรทำให้ราคา LINE Bot แต่ละเจ้าต่างกัน",
                "body": """
<p><strong>จำนวนฟีเจอร์</strong> — แค่ตอบแชท กับ ตอบแชท+จองคิว+เก็บข้อมูล+หลายสาขา
คนละราคากันแน่นอน เลือกจ่ายเฉพาะที่ร้านใช้จริงจะคุ้มสุด</p>

<p><strong>ความฉลาดของบอท</strong> — บอทคีย์เวิร์ดตายตัวราคาถูกกว่า แต่ลูกค้าถามนอกสคริปต์แล้วเงียบ
บอทที่เข้าใจประโยคธรรมชาติตอบได้ตรงประเด็นกว่า ลูกค้าไม่หนีไปกลางแชท</p>

<p><strong>การดูแลหลังส่งงาน</strong> — บางเจ้าคิดค่าแก้บอทครั้งละหลายร้อยถึงหลักพัน
ของเรารวมในค่ารายเดือนแล้ว แจ้งแก้ได้ตลอด ปกติเสร็จภายในวันเดียวกัน</p>

<p><strong>การเชื่อมระบบอื่น</strong> — ต้องต่อกับระบบหลังบ้าน สต็อก หรือ API ภายนอก
เป็นงานเฉพาะทางที่ทำให้ราคาขยับเป็นงานสร้างเฉพาะ</p>
""",
            },
            {
                "h2": "🕵️ ค่าใช้จ่ายแฝงที่ควรเช็คก่อนจ้างทุกเจ้า",
                "body": """
<p><strong>ค่า API</strong> — LINE / Facebook / Instagram API ใช้ฟรี
ถ้ามีใครเก็บ "ค่า API รายเดือน" แยกต่างหาก ให้ถามรายละเอียดดีๆ (ของเราไม่มี)</p>

<p><strong>โควตาข้อความ LINE OA</strong> — LINE OA มีข้อความฟรี 300 ข้อความ/เดือน
เพียงพอสำหรับร้านทั่วไป ถ้าเกินจะเป็นค่าใช้จ่ายฝั่ง LINE โดยตรง ไม่ใช่ค่าบริการของผู้พัฒนา
เจ้าไหนไม่บอกเรื่องนี้ล่วงหน้าให้ระวัง</p>

<p><strong>ค่าติดตั้ง / ค่าแก้งาน</strong> — เช็คให้ชัดว่ามีค่าแรกเข้าไหม แก้บอทครั้งละเท่าไหร่
ของเราไม่มีทั้งสองอย่าง จ่ายค่ารายเดือนอย่างเดียวจบ</p>

<div class="note">💡 คำถามเดียวที่ช่วยกันงบบานปลาย: "ราคานี้รวมอะไรบ้าง และอะไรที่ต้องจ่ายเพิ่ม"
— เจ้าที่ตอบชัดเจนคือเจ้าที่วางใจได้</div>
""",
            },
        ],
        "chat": [
            ("n", "ถามเรื่องราคากับเราได้ตรงๆ แบบนี้เลย"),
            ("u", "ร้านผมขายเสื้อผ้าออนไลน์ อยากได้บอทตอบแชท ราคาเท่าไหร่ครับ"),
            ("b", "เคสนี้ Starter ฿590/เดือน พอเลยค่ะ 😊<br>"
                  "ตอบราคา สต็อก วิธีสั่งซื้อ ได้ครบ ไม่ต้องมีคนเฝ้าแชท"),
            ("u", "ถ้าอยากให้รับออเดอร์ในแชทด้วยล่ะครับ"),
            ("b", "อัปเป็น Pro ฿1,290/เดือนค่ะ ได้ระบบรับออเดอร์ + เก็บข้อมูลลูกค้าให้เลย"),
            ("u", "มีค่าติดตั้งเพิ่มไหมครับ"),
            ("b", "ไม่มีค่ะ ✅ จ่ายรายเดือนอย่างเดียว ยกเลิกได้ทุกเมื่อ<br>"
                  "ลองเล่นเดโมฟรีก่อนตัดสินใจได้เลยค่ะ"),
        ],
        "plans": [
            ("Starter", "฿590/เดือน", "ตอบแชทอัตโนมัติ + ส่งข้อมูลสินค้า/บริการ"),
            ("Pro ⭐", "฿1,290/เดือน", "เพิ่มรับจองคิว/รับออเดอร์ (ร้านส่วนใหญ่เลือกตัวนี้)"),
            ("Business", "฿2,900/เดือน", "หลายสาขา/หลายทีม แยกการจัดการได้"),
            ("ระบบเฉพาะ", "฿5,000+ ครั้งเดียว", "สร้างตามสโคป เช่น ระบบคลินิก/เชื่อม API/เว็บแอป"),
        ],
        "faq": [
            ("มีค่าติดตั้งหรือค่าแรกเข้าไหม",
             "ไม่มีครับ แพ็กเกจรายเดือนจ่ายแค่ค่ารายเดือนอย่างเดียว เริ่มใช้ได้ใน 2-3 วัน "
             "ไม่มีสัญญาผูกมัด ยกเลิกได้ทุกเมื่อ"),
            ("ทำไมบางเจ้าคิดหลักหมื่นถึงหลักแสน",
             "งานหลักหมื่นขึ้นไปมักเป็นการเขียนระบบเฉพาะตามสโคป ซึ่งเราก็รับทำ (เริ่ม ฿5,000) "
             "แต่ร้านทั่วไปที่ต้องการบอทตอบแชท/จองคิว ใช้แพ็กเกจรายเดือน ฿590 ก็ครอบคลุมแล้ว "
             "ไม่จำเป็นต้องจ่ายก้อนใหญ่"),
            ("จ่ายรายเดือนแล้วได้อะไรบ้าง",
             "ได้ระบบบอทพร้อมใช้ + เราดูแลเซิร์ฟเวอร์ให้ทั้งหมด + แก้คำตอบ/เพิ่มข้อมูลให้ฟรีตลอดอายุใช้งาน "
             "ปกติแก้ให้ภายในวันเดียวกัน"),
            ("มีค่าใช้จ่ายเพิ่มจาก LINE ไหม",
             "LINE OA มีโควตาข้อความฟรี 300 ข้อความ/เดือน เพียงพอสำหรับร้านทั่วไป "
             "ถ้าเกินจะเป็นค่าใช้จ่ายฝั่ง LINE เอง เราแจ้งให้ทราบล่วงหน้าเสมอ ฝั่งเราไม่เก็บเพิ่ม"),
            ("เลือกรายเดือนหรือจ้างทำครั้งเดียวดี",
             "อยากได้บอทตอบแชท/จองคิวมาตรฐาน เลือกรายเดือน เริ่มไวกว่าและมีคนดูแลตลอด "
             "ต้องการระบบเฉพาะ เช่น เชื่อมระบบหลังบ้านเดิม หรือ workflow เฉพาะทาง "
             "ค่อยจ้างทำครั้งเดียวตามสโคป"),
            ("อัปเกรด/ดาวน์เกรดแพ็กเกจทีหลังได้ไหม",
             "ได้ครับ ทักแจ้งได้เลย ปรับให้มีผลรอบเดือนถัดไป ไม่มีค่าปรับ ไม่ต้องเริ่มระบบใหม่"),
            ("เทียบกับจ้างแอดมินเพิ่มคนนึงอันไหนคุ้มกว่า",
             "จ้างแอดมินเพิ่ม 1 คนเริ่มต้นหลักหมื่นบาท/เดือน และตอบได้ทีละแชท "
             "บอทเริ่ม ฿590/เดือน ตอบพร้อมกันได้ไม่จำกัด ตลอด 24 ชม. "
             "แล้วส่งต่อเคสที่ต้องคุยจริงจังให้คนดูแลต่อ"),
            ("ขอประเมินราคาก่อนได้ไหม",
             "ได้เลยครับ กดเล่นเดโมฟรีด้านบนก่อน แล้วทักมาเล่าประเภทร้านกับสิ่งที่อยากได้ "
             "เดี๋ยวแนะนำแพ็กเกจที่เหมาะให้ฟรี ไม่มีข้อผูกมัด"),
        ],
    },
    "bot-jongkiw": {
        ...
        "kw": "ระบบจองคิว, จองคิวออนไลน์, ระบบนัดหมาย, booking system, จองคิวผ่านไลน์, "
              "ระบบจองคิวร้านนวด, ระบบจองคิวคลินิกความงาม, แอปจองคิวออนไลน์, "
              "จองคิวผ่านเฟซบุ๊ก, ระบบนัดหมายอัตโนมัติราคาถูก",
        "lead": "ลูกค้าจองคิวเองได้ตลอด 24 ชม. — ไม่มีคิวหลุด ไม่ต้องนั่งเฝ้าแชท",
        "points": [
            ("🗓️", "ลูกค้าเลือกบริการ-วัน-เวลาเองในแชท"),
...
""",
        ...
        "faq": [
            ...
            ("ใช้แทนแอปจองคิวสำเร็จรูปได้ไหม",
             "ได้ครับ ต่างจากแอปสำเร็จรูปตรงที่ลูกค้าจองผ่านแชทที่คุ้นเคยอยู่แล้ว (LINE/Facebook) "
             "ไม่ต้องโหลดแอปใหม่ อัตราการจองสำเร็จเลยสูงกว่า"),
            ("รองรับหลายสาขาได้ไหม",
             "ได้ครับ แพ็กเกจ Business รองรับหลายสาขา/หลายทีมแยกคิวกันได้ในระบบเดียว"),
            ("ลูกค้ายกเลิก/เลื่อนนัดเองได้ไหม",
             "ได้ครับ ตั้งค่าให้ลูกค้ากดยกเลิกหรือขอเลื่อนผ่านแชทได้เอง "
             "ระบบแจ้งเตือนแอดมินทันทีที่มีการเปลี่ยนแปลง"),
        ],
    },
    "chatbot-clinic": {
        "h1": "รับทำ Chatbot สำหรับคลินิก",
        "title": "รับทำ Chatbot คลินิก + ระบบนัดหมาย | ตอบคำถามคนไข้อัตโนมัติ",
        "desc": "Chatbot สำหรับคลินิกความงาม ทันตกรรม กายภาพ ตอบราคาฟิลเลอร์ โบท็อกซ์ เลเซอร์ ร้อยไหม "
                "คัดกรองคนไข้ นัดหมาย+เตือนนัดอัตโนมัติ ออกแบบให้ปลอดภัยสำหรับสถานพยาบาล",
        "kw": "chatbot คลินิก, ระบบคลินิก, บอทคลินิกความงาม, ระบบนัดหมายคนไข้, "
              "แชทบอทคลินิกความงาม, ระบบนัดหมายทันตกรรม, บอทตอบคำถามคนไข้, "
              "line oa คลินิก, ระบบคิวโรงพยาบาลขนาดเล็ก",
...
""",
            ...
            {
                "h2": "🏥 ใช้ได้กับคลินิกแบบไหนบ้าง",
                "body": """
<p><strong>คลินิกความงาม</strong> — ตอบราคาโบท็อกซ์ ฟิลเลอร์ เลเซอร์ พร้อมโปรโมชั่นประจำเดือน
คัดกรองความสนใจก่อนส่งต่อให้ที่ปรึกษาปิดการขาย</p>

<p><strong>คลินิกทันตกรรม</strong> — ตอบค่าขูดหินปูน อุดฟัน ราคาจัดฟันเบื้องต้น
พร้อมรับนัดหมายและเตือนก่อนถึงวันนัด ลดปัญหาคนไข้ลืมนัดที่เจอกันทุกคลินิก</p>

<p><strong>คลินิกกายภาพบำบัด / คลินิกเฉพาะทาง</strong> — รับนัดต่อเนื่องเป็นคอร์สการรักษา
เห็นรายการนัดย้อนหลัง ช่วยติดตามให้คนไข้มาตามแผนการรักษาครบ</p>

<div class="note">💡 ระบบเดียวกัน แต่ปรับชุดคำถาม-คำตอบให้ตรงกับสาขาความเชี่ยวชาญของแต่ละคลินิก
ไม่ใช่บอทสำเร็จรูปที่ตอบเหมือนกันทุกที่</div>
""",
            },
            {
...
""",
            ...
            {
                "h2": "🔐 ข้อมูลคนไข้กับ PDPA",
                "body": """
<p><strong>เก็บเท่าที่จำเป็น</strong> — บอทเก็บเฉพาะข้อมูลติดต่อพื้นฐานสำหรับการนัดหมาย
(ชื่อ เบอร์โทร บริการที่สนใจ เวลานัด) ไม่เก็บข้อมูลสุขภาพผ่านแชท</p>

<p><strong>ข้อมูลเป็นของคลินิก</strong> — รายชื่อคนไข้และรายการนัดเป็นของคลินิกทั้งหมด
ต้องการดึงข้อมูลออกหรือให้ลบเมื่อไหร่ แจ้งได้ตลอด</p>

<p><strong>คำถามเชิงการแพทย์ไม่ผ่านบอท</strong> — อาการหรือแผนการรักษาเฉพาะบุคคล
บอทส่งต่อให้แพทย์/พยาบาลตอบเองเสมอ ไม่เดาคำตอบทางการแพทย์</p>

<div class="note">💡 ต้องการระบบบันทึกประวัติการรักษาเต็มรูปแบบ
มีเป็นระบบเสริมแยกต่างหาก กำหนดสิทธิ์การเข้าถึงข้อมูลของทีมงานแต่ละคนได้</div>
""",
            },
            {
                "h2": "🆚 บอทคลินิกของเราต่างจากบอททั่วไปอย่างไร",
                "body": """
<p><strong>บอททั่วไปตอบได้แค่คำถามง่าย</strong> — "ราคาเท่าไหร่" "เปิดกี่โมง" พอไหว
แต่พอคนไข้ถามเชิงเปรียบเทียบ เช่น "โบท็อกซ์มีกี่แบบ ต่างกันยังไง อยู่ได้นานต่างกันไหม"
มักตอบไม่ตรงคำถาม แล้วโยนกลับไปที่ "รอแอดมินตอบนะคะ" เหมือนเดิม</p>

<p><strong>คนที่ถามละเอียด คือคนที่ใกล้ตัดสินใจที่สุด</strong> — คำถามเชิงเปรียบเทียบ
ไม่ใช่คำถามกวนใจ แต่เป็นสัญญาณว่าคนไข้กำลังชั่งใจเลือกจริงๆ
ปล่อยให้รอคำตอบนานเท่ากับส่งลูกค้าที่พร้อมที่สุดให้คลินิกคู่แข่ง</p>

<p><strong>บอทของเราคุยเป็นบทสนทนา</strong> — เข้าใจคำถามเปรียบเทียบ
อธิบายความต่างของแต่ละบริการได้จริงจากข้อมูลที่คลินิกกำหนดไว้
แล้วชวนต่อไปที่การนัดหมายในแชทเดียวกัน</p>

<div class="note">💡 ธุรกิจความงามสายอื่นก็ใช้แนวทางเดียวกันได้ —
ดู <a href="/bot-ran-serm-suay">บอทร้านเสริมสวย</a> · <a href="/bot-spa">บอทร้านสปา &amp; นวด</a>
หรือเช็ค <a href="/line-bot-raka">ราคา LINE Bot ทุกแพ็กเกจ</a></div>
""",
            },
            {
                "h2": "🛡️ ปลอดภัยสำหรับสถานพยาบาล",
                "body": """
<p><strong>คลินิกเวชกรรมอยู่ภายใต้ใบอนุญาต</strong> — ทุกข้อความที่ระบบพิมพ์ออกไป
ถือเป็นความรับผิดชอบของคลินิก บอทสำหรับสถานพยาบาลจึงออกแบบแบบ "ตอบไปก่อน"
เหมือนบอทร้านค้าทั่วไปไม่ได้</p>

<p><strong>บอทถูกล็อกขอบเขตไว้ชัดเจน</strong> — ตอบได้เฉพาะราคา คิวว่าง เวลาทำการ
ที่ตั้งคลินิก และคำอธิบายบริการตามข้อมูลที่คลินิกอนุมัติไว้เท่านั้น ไม่ตอบเรื่องการรักษา</p>

<p><strong>คำถามเชิงการแพทย์ส่งต่อทันที</strong> — เช่น "หน้าแบบนี้ควรฉีดอะไร"
บอทจะไม่วินิจฉัยหรือแนะนำหัตถการเอง แต่ส่งต่อให้เจ้าหน้าที่ของคลินิกตอบ
เพื่อให้คำแนะนำทางการแพทย์มาจากผู้มีใบอนุญาตเสมอ</p>

<div class="note">⚕️ หลักคิดข้อเดียว: บอทช่วยงานหน้าบ้านให้เร็วขึ้น
ส่วนการตัดสินใจทางการแพทย์อยู่กับทีมแพทย์ของคลินิก 100% เสมอ</div>
""",
            },
        ],
        "chat": [
        ...
        "faq": [
            ...
            ("ใช้กับคลินิกทันตกรรม/กายภาพบำบัดได้ไหม",
             "ได้ครับ ปรับคำถาม/ขั้นตอนบอทให้ตรงกับแต่ละสาขาความเชี่ยวชาญได้ "
             "ไม่ใช่แค่คลินิกความงามอย่างเดียว"),
            ("มี Rich Menu ให้คนไข้กดดูราคา/นัดหมายเองไหม",
             "มีครับ ตั้ง Rich Menu ปุ่มลัดให้คนไข้กดดูราคา จองคิว หรือดูที่อยู่คลินิกได้โดยไม่ต้องพิมพ์"),
            ("รองรับหลายสาขาคลินิกไหม",
             "รองรับครับ เลือกแยกคิว/ข้อมูลแต่ละสาขา หรือรวมศูนย์บริหารที่เดียวก็ได้"),
            ("ระบบเตือนนัดส่งถึงคนไข้ทางไหน",
             "ส่งเข้า LINE ของคนไข้โดยตรงก่อนถึงวันนัด และแจ้งทีมงานคลินิกพร้อมกัน "
             "ไม่ต้องโทรไล่ตามยืนยันทีละคน"),
            ("รับนัดนอกเวลาทำการได้ไหม",
             "ได้ครับ บอทรับนัดได้ 24 ชม. โดยเปิดให้เลือกเฉพาะช่วงเวลาที่คลินิกกำหนดไว้ "
             "คนไข้ทักตอนดึกก็จองคิวของวันถัดไปได้เลย ไม่ต้องรอคลินิกเปิด"),
            ("ต่างจากจ้างแอดมินเพิ่มยังไง",
             "แอดมิน 1 คนเริ่มต้นหลักหมื่นบาท/เดือน และตอบได้ทีละแชท "
             "บอทเริ่ม ฿590/เดือน ตอบพร้อมกันได้ไม่จำกัดตลอด 24 ชม. "
             "แล้วส่งต่อเคสที่ต้องใช้ดุลยพินิจให้ทีมงานตัวจริง"),
            ("คนไข้ขอเลื่อนหรือยกเลิกนัดผ่านบอทได้ไหม",
             "ได้ครับ แจ้งเลื่อน/ยกเลิกในแชทได้เลย ระบบบันทึกและแจ้งทีมงานทันที "
             "คิวที่ว่างลงก็เปิดให้คนไข้รายอื่นจองต่อได้ ไม่เสียช่วงเวลานั้นฟรี"),
            ("ใช้ได้ทั้ง LINE และ Facebook ไหม",
             "ได้ครับ รองรับทั้ง LINE OA และ Facebook Messenger เลือกใช้ช่องทางเดียว "
             "หรือใช้คู่กันก็ได้ คำถามคนไข้และรายการนัดรวมมาที่ทีมงานที่เดียว"),
        ],
    },
    "bot-ran-serm-suay": {
        ...
        "kw": "บอทร้านเสริมสวย, บอทร้านทำผม, บอทร้านเล็บ, จองคิวร้านเสริมสวย, ระบบร้านทำผม, "
              "line oa ร้านเสริมสวย, บอทร้านสปา, ระบบจองคิวร้านเล็บ, "
              "แชทบอทร้านทำผมราคาถูก, จองคิวร้านนวดผ่านไลน์",
        "lead": "ลูกค้าทักตอนดึก ตอนคิวเต็มมือ ก็มีคนตอบ — บอทส่งราคา ผลงาน และรับจองคิวให้",
        "points": [
            ("💇", "ส่งเมนูบริการ + ราคา ให้ลูกค้าดูเอง"),
            ("🖼️", "ส่งรูปผลงานเป็นแคตตาล็อกเลื่อนดูได้"),
...
""",
        ...
        "faq": [
            ...
            ("จองผ่าน Instagram ได้ไหม",
             "ตอนนี้รองรับ LINE และ Facebook Messenger เป็นหลักครับ "
             "ถ้าต้องการเชื่อม Instagram DM เพิ่มเติม คุยรายละเอียดเพิ่มได้เลย"),
            ("ลูกค้าดูราคาก่อนจองได้ไหม",
             "ได้ครับ ตั้ง Rich Menu ปุ่มดูราคา/บริการทั้งหมดไว้ให้กดดูก่อนตัดสินใจจองได้เลย"),
            ("ถ้าร้านมีโปรโมชั่นบ่อยๆ อัปเดตยังไง",
             "แจ้งมาได้เลยครับ ปกติอัปเดตข้อความ/ราคาในบอทให้ภายในวันเดียวกัน ไม่ต้องรอคิวนาน"),
        ],
    },
    "bot-spa": {
        "h1": "รับทำ LINE Bot ร้านสปา & นวด",
        "title": "รับทำ LINE Bot ร้านสปา นวดแผนไทย | รับจองคิวอัตโนมัติ ฿590/เดือน",
        "desc": "บอทตอบแชทร้านสปา นวดแผนไทย นวดน้ำมัน ตอบราคาคอร์ส รับจองคิว เลือกหมอนวด "
                "เตือนก่อนถึงเวลานัด ลูกค้าจองได้แม้ทั้งร้านกำลังติดคอร์สอยู่ ลองฟรีก่อนตัดสินใจ",
        "kw": "บอทร้านสปา, line bot สปา, line oa ร้านนวด, ระบบจองคิวร้านนวด, "
              "บอทจองคิวสปา, แชทบอทนวดแผนไทย, ระบบจองคิวหมอนวด, บอทตอบแชทร้านนวด, "
              "line bot ร้านนวดแผนไทย, ระบบคิวร้านสปา",
        "lead": "มือกำลังนวดอยู่ ตอบแชทไม่ได้ — ให้บอทตอบราคาคอร์ส จองคิว เลือกเวลาแทน ลูกค้าไม่หลุดไปร้านอื่น",
        "points": [
            ("💆", "ตอบราคาคอร์สนวด/สปาอัตโนมัติ"),
            ("📅", "จองคิว เลือกเวลา-หมอนวดได้ในแชท"),
            ("🔔", "เตือนก่อนถึงเวลานัด ลดลูกค้าเทนัด"),
            ("🌿", "Rich Menu เมนูคอร์สสวยงาม กดดูได้เลย"),
        ],
        "sections": [
            {
                "h2": "😩 ทำไมร้านสปา/นวดถึงตอบแชทช้ากว่าธุรกิจอื่น",
                "body": """
<p><strong>มือไม่ว่างจริงๆ</strong> — คอร์สนวดหนึ่งรอบกินเวลา 1-2 ชั่วโมงเต็ม
ระหว่างนั้นไม่มีใครหยิบมือถือได้เลย กว่าจะว่างมาตอบ ลูกค้าจองร้านอื่นไปแล้ว</p>

<p><strong>ลูกค้าสปาตัดสินใจไว</strong> — คนอยากนวดคือคนที่เมื่อยตอนนี้
ถามร้านไหนตอบก่อนก็ไปร้านนั้น ไม่รอคำตอบข้ามชั่วโมง</p>

<p><strong>คิวซ้อนเพราะจดมือ</strong> — รับจองผ่านแชทแล้วจดใส่สมุด
พอลูกค้าหลายคนทักพร้อมกัน เวลาชนกันโดยไม่รู้ตัว เสียลูกค้าทั้งสองคิว</p>

<div class="note">💡 บอทไม่ได้มาแทนหมอนวด — มันมารับแชทตอนที่ทั้งร้านติดคอร์สอยู่
แล้วเก็บคิวให้เป็นระเบียบ ไม่ให้ลูกค้าหลุดมือไปเฉยๆ</div>
""",
            },
            {
                "h2": "🤖 บอทช่วยร้านสปา/นวดตรงไหนบ้าง",
                "body": """
<p><strong>ตอบเมนูคอร์ส + ราคาแทน</strong> — นวดไทย นวดน้ำมัน สครับ แพ็กเกจคู่
ลูกค้าถามแบบไหนบอทก็ดึงราคาจากเมนูจริงของร้านมาตอบทันที</p>

<p><strong>รับจองคิวในแชท</strong> — ลูกค้าเลือกคอร์ส เลือกเวลา ระบุจำนวนคนได้เอง
ระบบบันทึกเป็นระเบียบ แอดมินเห็นคิวใหม่ทันทีโดยไม่ต้องวางมือจากลูกค้าตรงหน้า</p>

<p><strong>เตือนนัดอัตโนมัติ</strong> — แจ้งเตือนลูกค้าก่อนถึงเวลานัด
ลดปัญหาจองแล้วไม่มา ที่ทำให้เตียงว่างฟรีทั้งชั่วโมง</p>

<p><strong>เก็บข้อมูลลูกค้าประจำ</strong> — ใครชอบคอร์สไหน มาบ่อยแค่ไหน
มีข้อมูลพร้อมทำโปรโมชั่นชวนกลับมาใช้บริการ</p>
""",
            },
            {
                "h2": "🛠 เริ่มใช้งานยังไง ต้องเตรียมอะไร",
                "body": """
<p>เตรียม 3 อย่าง: เมนูคอร์ส+ราคา, ตารางเวลาที่รับคิวได้ (จำนวนเตียง/หมอนวด),
คำถามที่ลูกค้าถามบ่อยที่สุด — ส่งมาให้เรา ตั้งค่าเสร็จภายใน 2-3 วัน ทดลองก่อนเปิดใช้จริง</p>
<p>มี LINE OA อยู่แล้วเชื่อมของเดิมได้เลย ลูกค้าเก่าไม่หาย ยังไม่มีก็สมัครฟรีได้ เราสอนให้</p>
""",
            },
        ],
        "chat": [
            ("n", "20:45 น. — หมอนวดทุกคนกำลังติดคอร์ส ไม่มีใครว่างตอบแชท"),
            ("u", "สวัสดีค่ะ นวดน้ำมันคู่ พรุ่งนี้เย็นว่างไหมคะ"),
            ("b", "สวัสดีค่ะ 🌿 นวดน้ำมันอโรม่า 90 นาที คู่ละ 1,590฿ ค่ะ<br>"
                  "พรุ่งนี้เย็นมีคิวว่าง 17:00 กับ 19:30 ค่ะ สะดวกเวลาไหนคะ"),
            ("u", "19:30 ค่ะ"),
            ("b", "ได้ค่ะ ✅ ขอชื่อกับเบอร์ติดต่อหน่อยนะคะ"),
            ("u", "ฝน 08x-xxx-xxxx ค่ะ"),
            ("b", "จองเรียบร้อยค่ะ 🎉<br>คุณฝน · นวดน้ำมันคู่ 90 นาที · พรุ่งนี้ 19:30<br>"
                  "ก่อนถึงเวลานัดระบบจะแจ้งเตือนอีกครั้งนะคะ"),
            ("n", "⚡ แอดมินเห็นคิวใหม่ทันที ไม่ต้องวางมือจากลูกค้าตรงหน้า"),
        ],
        "plans": [
            ("Starter", "฿590", "ตอบราคาคอร์ส/เวลาเปิด + ข้อมูลร้าน"),
            ("Pro ⭐", "฿1,290", "เพิ่มระบบจองคิว + เตือนนัด (นิยมสุด)"),
            ("Business", "฿2,900", "หลายหมอนวด/หลายสาขา แยกคิวได้"),
        ],
        "faq": [
            ("ร้านมีหมอนวดหลายคน แยกคิวแต่ละคนได้ไหม",
             "ได้ครับ แพ็กเกจ Business รองรับแยกคิวรายหมอนวด/รายห้อง "
             "หรือจะรวมเป็นคิวกลางของร้านก็ได้ แล้วแต่วิธีทำงานของร้าน"),
            ("ลูกค้าจองแล้วไม่มา ระบบช่วยอะไรได้บ้าง",
             "ระบบแจ้งเตือนลูกค้าก่อนถึงเวลานัดอัตโนมัติ ช่วยลดอัตราเทนัดได้มาก "
             "และแอดมินเห็นรายการนัดล่วงหน้าทั้งหมด จะโทรยืนยันเฉพาะคิวสำคัญเพิ่มก็ได้"),
            ("มี LINE OA อยู่แล้ว ลูกค้าเก่าจะหายไหม",
             "ไม่หายครับ เชื่อมบอทเข้ากับ LINE OA เดิมได้เลย ลูกค้าเก่าอยู่ครบ "
             "ไม่ต้องย้ายไลน์ใหม่"),
            ("คอร์สเยอะ ราคาหลายแบบ บอทจำไหวไหม",
             "ไหวครับ ใส่เมนูได้ไม่จำกัด ทั้งนวดไทย นวดน้ำมัน สครับ แพ็กเกจคู่ "
             "บอทตอบราคาถูกตัวเสมอเพราะดึงจากเมนูที่ตั้งไว้ตรงๆ ไม่ได้เดา"),
            ("ปรับราคา/เพิ่มโปรโมชั่นทีหลังได้ไหม",
             "ได้ตลอดครับ ทักแจ้งได้เลย ไม่มีค่าใช้จ่ายเพิ่ม ปกติแก้ให้ภายในวันเดียวกัน"),
            ("ราคาเริ่มต้นเท่าไหร่",
             "เริ่ม ฿590/เดือน ไม่มีค่าติดตั้ง ร้านสปาส่วนใหญ่เลือก Pro ฿1,290 "
             "เพราะได้ระบบจองคิว + เตือนนัดด้วย"),
            ("ใช้เวลาติดตั้งกี่วัน",
             "2-3 วัน นับจากวันที่ส่งเมนูคอร์ส ราคา และตารางเวลาที่รับคิวมาให้"),
            ("มี Rich Menu ให้ลูกค้ากดจองเองไหม",
             "มีครับ ตั้งปุ่มลัด ดูคอร์ส-ราคา จองคิว ดูแผนที่ร้าน "
             "ลูกค้ากดได้เลยไม่ต้องพิมพ์อะไร"),
            ("ขอทดลองก่อนได้ไหม",
             "ได้เลยครับ กดเล่นเดโมร้านสปาด้านบนได้เลย เหมือนเป็นลูกค้าจริง ไม่ต้องสมัคร"),
        ],
    },
    "bot-ran-ahan": {
        ...
        "kw": "บอทร้านอาหาร, จองโต๊ะออนไลน์, ระบบร้านอาหาร, บอทคาเฟ่, รับออเดอร์อัตโนมัติ, "
              "line oa ร้านอาหาร, บอทรับออเดอร์ผ่านไลน์, ระบบจองโต๊ะร้านอาหารราคาถูก, "
              "แชทบอทร้านกาแฟ, เมนูอาหารผ่านไลน์",
        "lead": "ช่วงพีคมือไม่ว่าง — ให้บอทส่งเมนู รับจองโต๊ะ ตอบคำถามซ้ำๆ แทน",
        "points": [
            ("🍽️", "ส่งเมนู + ราคา ให้ลูกค้าดูในแชท"),
...
""",
        ...
        "faq": [
            ...
            ("ขอทดลองก่อนได้ไหม",
             "ได้เลยครับ กดดูตัวอย่างระบบจริงด้านบนได้เลย ไม่ต้องสมัคร"),
            ("รับออเดอร์แบบมีรูปเมนูได้ไหม",
             "ได้ครับ ใช้ Flex Message โชว์เมนูพร้อมรูปสวยงามในแชท ลูกค้ากดเลือกได้เลย "
             "ไม่ต้องพิมพ์ชื่อเมนู"),
            ("เชื่อมกับระบบสั่งอาหารเดลิเวอรีที่มีอยู่ได้ไหม",
             "เชื่อมได้บางส่วนครับ ขึ้นอยู่กับว่าระบบเดิมเปิด API ให้เชื่อมหรือไม่ "
             "แนะนำให้ปรึกษารายละเอียดก่อนเริ่มทำ"),
            ("ใช้กับร้านที่ไม่มีหน้าร้าน (คลาวด์คิทเช่น) ได้ไหม",
             "ได้ครับ เหมาะมากเพราะลูกค้าสั่งผ่านแชทได้โดยตรง ไม่ต้องพึ่งแอปเดลิเวอรีอย่างเดียว"),
        ],
    },
    "n8n-automation": {
        ...
        "kw": "n8n, automation, รับทำ automation, ระบบอัตโนมัติ, make.com, zapier, ai agent, rpa, "
              "รับทำ workflow automation, เชื่อม google sheet กับ line, ระบบแจ้งเตือนอัตโนมัติ, "
              "ai agent ทำงานแทนคน, รับวาง n8n self-hosted",
        ...
        "points": [
            ...
            ("🕸️", "ดักจับข้อมูลจากเว็บ/API → ส่งรายงานเข้า LINE"),
            ("⚠️", "แจ้งเตือน error + retry อัตโนมัติ"),
        ],
        "sections": [
            {
...
""",
        ...
        "faq": [
            ...
            ("ใช้ n8n แบบ self-hosted ได้ไหม",
             "ได้ครับ วางระบบ n8n แบบ self-hosted บนเซิร์ฟเวอร์ของคุณเองก็ได้ "
             "ถ้าต้องการควบคุมข้อมูลเต็มรูปแบบ หรือจะใช้ cloud ของเราก็ได้เช่นกัน"),
            ("ต่างจากการจ้างโปรแกรมเมอร์เขียนเองยังไง",
             "n8n ทำได้เร็วกว่าและถูกกว่าการเขียนโค้ดตั้งแต่ศูนย์มาก เพราะมี node สำเร็จรูป "
             "เชื่อมต่อระบบส่วนใหญ่ให้แล้ว เหมาะกับ workflow ที่ไม่ซับซ้อนระดับ enterprise"),
            ("มีระบบแจ้งเตือนถ้า workflow พังไหม",
             "มีครับ ตั้งค่าแจ้งเตือนเข้า LINE ทันทีถ้า workflow ไหนล้มเหลวหรือหยุดทำงาน "
             "ไม่ต้องคอยเข้าไปเช็คเอง"),
        ],
    },
    "portfolio-website": {
        "h1": "รับทำเว็บไซต์ Portfolio สมัครงาน",
        "title": "รับทำเว็บไซต์ Portfolio สมัครงาน อ่านง่าย ทันสมัย | เริ่ม ฿1,200",
        "desc": "รับทำเว็บไซต์ Portfolio สำหรับสมัครงาน/แนะนำตัว จัดวางข้อมูลอ่านง่าย ดีไซน์ทันสมัยแบบมืออาชีพ ปรับให้ตรงกับสายงานที่สมัคร ส่งงาน 3-5 วัน",
        "kw": "ทำเว็บ portfolio สมัครงาน, เว็บไซต์ resume ส่วนตัว, รับทำเว็บพอร์ตโฟลิโอ, portfolio website, ทำเว็บแนะนำตัว, เว็บสมัครงานออนไลน์, ทำเว็บส่วนตัวราคาถูก",
        "lead": "เว็บไซต์ Portfolio ที่เปิดดูได้ทันทีจากลิงก์ อ่านง่าย ดีไซน์ทันสมัย แต่ยังดูมืออาชีพน่าเชื่อถือ — ไม่ใช่แค่ไฟล์ PDF",
        "points": [
            ("📐", "จัดวางข้อมูลเป็นระบบ อ่านง่าย เข้าใจได้ในไม่กี่วินาที"),
            ("✨", "ดีไซน์ทันสมัยแบบ Gen Z แต่ไม่ใส่ลูกเล่นเกินจำเป็น"),
            ("🎯", "ปรับให้เหมาะกับสายงานที่คุณสมัคร ไม่ใช่เทมเพลตสำเร็จรูป"),
            ("📱", "รองรับมือถือ 100% เปิดจากมือถือก็สวย"),
        ],
        "price_line": "เริ่มต้น ฿1,200 (จ่ายครั้งเดียว)",
        "price_note": "ไม่มีค่ารายเดือน · ส่งไฟล์ + ลิงก์พร้อมใช้ · ปรับแก้ได้ตามแพ็กเกจ",
        "price_value": "1200",
        "plans_label": "ราคา",
        "og_tagline": "เว็บพร้อมใช้ใน 3-5 วัน",
        "og_sub": "จัดวางข้อมูลอ่านง่าย ดีไซน์ทันสมัย ปรับให้ตรงกับสายงานที่สมัคร",
        "og_price_pill": "เริ่ม ฿1,200",
        "cta_url": "https://fastwork.co/byob/TtC8gpKfYN",
        "cta_label": "ดูแพ็กเกจ/สั่งซื้อบน FastWork →",
        "sections": [
            {
                "h2": "😩 ทำไมเรซูเม่แบบ PDF อย่างเดียวไม่พอแล้ว",
                "body": """
<p><strong>HR เปิดดูแค่ไม่กี่วินาที</strong> — ไฟล์ PDF หน้าตาเดิมๆ ต้องเลื่อนอ่านทีละหน้า
ถ้าจัดวางไม่ดี ข้อมูลสำคัญอาจถูกมองข้ามไปเลยตั้งแต่ 5 วินาทีแรก</p>

<p><strong>เปิดจากมือถือไม่สะดวก</strong> — คนเปิดดูใบสมัครจากมือถือเยอะขึ้นเรื่อยๆ
แต่ PDF ส่วนใหญ่ไม่ได้ออกแบบมาให้อ่านง่ายบนจอเล็ก ต้องซูมเข้าซูมออกตลอด</p>

<p><strong>ไม่มีอะไรให้จดจำ</strong> — เรซูเม่หน้าตาเหมือนกันหมดแยกไม่ออกว่าใครเป็นใคร
เว็บ Portfolio ที่ออกแบบมาให้ตรงตัวตนคุณ ช่วยให้จำได้และดูน่าเชื่อถือกว่า</p>

<div class="note">💡 เว็บ Portfolio ไม่ได้มาแทนเรซูเม่ — มันมาเสริมให้ผู้พิจารณาเห็นตัวตนคุณชัดขึ้น
ก่อนตัดสินใจนัดสัมภาษณ์</div>
""",
            },
            {
                "h2": "🎨 เว็บ Portfolio ของเราต่างจากเทมเพลตทั่วไปยังไง",
                "body": """
<p><strong>ไม่ใช่เทมเพลตสำเร็จรูป</strong> — ออกแบบให้ตรงกับตัวตนและสายงานที่คุณสมัคร
ไม่ใช่แค่เปลี่ยนชื่อในเทมเพลตเดิมที่ใครก็ใช้ซ้ำกันได้</p>

<p><strong>จัดลำดับข้อมูลตามหลัก UX</strong> — เรียงเนื้อหาให้คนอ่านเจอสิ่งสำคัญก่อนเสมอ
ไม่ใช่ยัดทุกอย่างไว้หน้าเดียวจนอ่านยาก</p>

<p><strong>ใช้ได้กว้างกว่าแค่สมัครงาน</strong> — ปรับใช้เป็นเว็บแนะนำตัวสำหรับฟรีแลนซ์
หรือธุรกิจส่วนตัวก็ได้ในโครงสร้างเดียวกัน</p>
""",
            },
            {
                "h2": "🛠 เริ่มใช้งานยังไง",
                "body": """
<p><strong>เตรียมแค่:</strong> ประวัติ/ผลงานที่มีอยู่แล้ว (ไม่ต้องเรียบเรียงเองก่อนส่งมา)
และสายงานที่กำลังจะสมัคร</p>
<p><strong>ขั้นตอน:</strong> ส่งข้อมูลมา → ออกแบบ+พัฒนา → ส่งลิงก์พรีวิวให้ดูก่อน →
ปรับแก้ตามที่ต้องการ → ส่งไฟล์ + ลิงก์พร้อมใช้ ใช้เวลารวม 3-5 วันทำการ</p>
""",
            },
        ],
        "chat": [
            ("n", "กำลังหางานสาย Content Marketing"),
            ("u", "อยากได้เว็บ Portfolio อ่านง่าย ทันสมัย ราคาเท่าไหร่ครับ"),
            ("b", "เริ่มต้น 1,200 บาทครับ 😊 ส่งประวัติ/ผลงานที่มีมาได้เลย "
                  "ออกแบบให้ตรงกับสายงานที่สมัคร"),
            ("u", "ส่งงานไวไหมครับ"),
            ("b", "3-5 วันทำการครับ ระหว่างทำมีลิงก์พรีวิวให้ดูก่อนด้วย ปรับแก้ได้จนพอใจ"),
            ("n", "⚡ 4 วันต่อมา — ลิงก์เว็บพร้อมใช้งาน"),
            ("b", "เว็บพร้อมแล้วครับ 🎉 เปิดจากมือถือก็สวย ส่งแนบไปกับใบสมัครได้เลย"),
        ],
        "plans": [
            ("Basic", "฿1,200", "หน้าเดียว (One-page) ครบทุกส่วนสำคัญ"),
            ("Standard ⭐", "฿2,500", "เพิ่มหลายหน้า + ตั้งค่าโดเมนของตัวเอง (นิยมสุด)"),
            ("Premium", "฿4,500", "ออกแบบพิเศษเฉพาะคุณ + ปรับไม่จำกัดใน 30 วัน"),
        ],
        "faq": [
            ("ต้องส่งข้อมูลอะไรให้บ้าง",
             "ส่งประวัติ/ผลงานที่มีอยู่แล้ว พร้อมบอกสายงานที่จะสมัคร "
             "ไม่ต้องเรียบเรียงเองก่อนส่งมาก็ได้ เดี๋ยวช่วยจัดลำดับให้อ่านง่ายขึ้น"),
            ("ไม่มีผลงานเยอะ ทำได้ไหม",
             "ได้ครับ ออกแบบให้เน้นจุดแข็งที่มี เช่น ทักษะ การศึกษา หรือโปรเจกต์เล็กๆ ที่เคยทำ "
             "ไม่จำเป็นต้องมีพอร์ตใหญ่มาก่อน"),
            ("ได้โดเมนของตัวเองไหม",
             "แพ็กเกจ Standard ขึ้นไปช่วยตั้งค่าโดเมนให้ (เช่น yourname.com) "
             "ถ้าไม่ต้องการโดเมนก็ใช้ลิงก์ที่ให้ได้ฟรีเลย"),
            ("แก้ไขทีหลังได้ไหม",
             "ได้ครับ ตามจำนวนครั้งในแต่ละแพ็กเกจ หลังจากนั้นมีค่าใช้จ่ายเพิ่มเติมเล็กน้อยตามความซับซ้อน"),
            ("ใช้เวลาทำนานแค่ไหน",
             "3-5 วันทำการ นับจากวันที่ได้ข้อมูล/ผลงานครบ"),
            ("เหมาะกับสายงานไหนบ้าง",
             "ทุกสายงานครับ ทั้งสาย Creative, Marketing, Developer, Designer "
             "หรือใครที่อยากมีเว็บแนะนำตัวส่วนตัวก็ได้"),
            ("มีค่าใช้จ่ายรายเดือนไหม",
             "ไม่มีครับ จ่ายครั้งเดียวจบ ยกเว้นถ้าเลือกจดโดเมน/โฮสต์เอง "
             "ซึ่งเป็นค่าใช้จ่ายปีละเล็กน้อยจากผู้ให้บริการโดเมนโดยตรง ไม่ใช่ค่าใช้จ่ายกับเรา"),
            ("ขอดูตัวอย่างก่อนได้ไหม",
             "ได้เลยครับ มีตัวอย่างจริงให้ดูก่อนตัดสินใจ ทักมาขอลิงก์ตัวอย่างได้เลย"),
        ],
    },
}
...
def _rich_blocks(p: dict) -> tuple:
    ...
    if p.get("plans"):
        ...
        plans_label = p.get("plans_label", "ราคา/เดือน")
        tbl = ('<h2>💰 ราคา</h2><table class="tb">'
               f'<tr><th>แพ็กเกจ</th><th>{plans_label}</th><th>เหมาะกับ</th></tr>'
               f'{rows}</table>')
...
SEO_SLUG_BIZ = {
    ...
    "line-bot-raka": "general", "bot-spa": "spa",
}
...
SEO_ACCENT = {
    ...
    "portfolio-website": ("#fbbf24", "#1a1204", "rgba(251,191,36,.13)"),
    "line-bot-raka":     ("#a3e635", "#101803", "rgba(163,230,53,.13)"),
    "bot-spa":           ("#2dd4bf", "#03151a", "rgba(45,212,191,.13)"),
}
...
def _seo_page(slug: str) -> str:
    ...
    pts = "".join(
        f'<div class="card"><span class="ic">{icon}</span><b>{txt}</b></div>'
        for icon, txt in p["points"]
    )
    botkit_url = f"/botkit?biz={SEO_SLUG_BIZ.get(slug, '')}#order" if SEO_SLUG_BIZ.get(slug) else "/botkit"
    # ราคา/ปุ่ม CTA ปรับต่อหน้าได้ (ดีฟอลต์ = ค่าเดิมของ 6 หน้าแรกที่เป็นแพ็กเกจรายเดือน ฿590 ทุกตัวอักษร)
    cta_url = p.get("cta_url", botkit_url)
    cta_label = p.get("cta_label", "ดูแพ็กเกจทั้งหมด →")
    price_line = p.get("price_line", "เริ่มต้น ฿590/เดือน")
    price_note = p.get("price_note", "ไม่มีค่าติดตั้ง · ยกเลิกได้ทุกเมื่อ · ไม่ผูกมัด")
    price_value = p.get("price_value", "590")
    secs, chat, tbl, faq_html, faq_ld = _rich_blocks(p)
    # Service JSON-LD: สร้างผ่าน json.dumps กัน escape พัง (แบบเดียวกับ breadcrumb)
    # hasOfferCatalog ดึงจากตารางราคาจริงของหน้า (p["plans"]) — ราคาเลยตรงกับที่ตาเห็นเสมอ
    catalog_offers = []
    for _pname, _pprice, _pfit in p.get("plans", []):
        _digits = re.sub(r"[^0-9]", "", _pprice)
        if _digits:
            catalog_offers.append({
                "@type": "Offer", "name": _pname.replace("⭐", "").strip(),
                "price": _digits, "priceCurrency": "THB", "description": _pfit,
            })
    service_obj = {
        "@context": "https://schema.org", "@type": "Service",
        "name": p["h1"], "serviceType": p["h1"], "description": p["desc"],
        "url": f"{BASE_URL}/{slug}", "image": og_img,
        "areaServed": {"@type": "Country", "name": "Thailand"},
        "provider": {"@type": "Person", "name": "Jark",
                     "jobTitle": "LINE Bot & AI Agent Developer"},
        "offers": {"@type": "Offer", "price": price_value, "priceCurrency": "THB"},
    }
    if catalog_offers:
        service_obj["hasOfferCatalog"] = {
            "@type": "OfferCatalog", "name": "แพ็กเกจและราคา",
            "itemListElement": catalog_offers,
        }
    service_ld = ('<script type="application/ld+json">'
                  + json.dumps(service_obj, ensure_ascii=False) + "</script>")
    # ลิงก์ลงหน้าเทียบราคา (internal link) — ทุกหน้ายกเว้นหน้า line-bot-raka เอง
    price_link = ("" if slug == "line-bot-raka" else
                  '<br><a href="/line-bot-raka">เทียบราคาละเอียดทุกแพ็กเกจ →</a>')
    demos = "".join(
...
.grid{{display:grid;grid-template-columns:1fr 1fr;gap:14px;margin:24px 0 30px}}
...
.card b{{display:block;font-size:15.5px;color:#fff;line-height:1.5;font-weight:700}}
...
strong{{color:var(--ac)}}
p a,.note a{{color:var(--ac);text-decoration:underline;text-underline-offset:3px}}
...
.price a{{color:var(--ac);text-decoration:none;font-size:14.5px;font-weight:600}}
...
<div class="price">
  💰 <b>{price_line}</b><br>
  <span style="color:#a8b8d6;font-size:14.5px">{price_note}</span>{price_link}
</div>
...
# lastmod กลางของ sitemap — bump เป็นวันที่แก้เนื้อหาจริงครั้งล่าสุด (แก้หน้าเดียว: ใส่ "updated" ใน SEO_PAGES หน้านั้นแทน)
# ห้ามกลับไปใช้ datetime.now(): lastmod ที่ขยับทุก request ทั้งที่เนื้อหาไม่เปลี่ยน ทำให้ Google เลิกเชื่อทั้ง sitemap
...
def sitemap():
    ...
    urls = [("/", SITE_UPDATED), ("/chatmaker/", SITE_UPDATED)] + [
        (f"/{k}", v.get("updated", SITE_UPDATED)) for k, v in SEO_PAGES.items()
    ]
    items = "".join(
        f"<url><loc>{BASE_URL}{u}</loc><lastmod>{lastmod}</lastmod>"
...
@app.route("/webhook/line/rangkafae", methods=["POST"])
def rangkafae_line_webhook():
    """LINE OA webhook ของ "รังกาแฟ" (ร้านจำลองคุมเอง — เดโม/เคสศึกษานกน้อยเปิดรัง, 23 ก.ค. 2026)
    ก๊อปแพทเทิร์นจาก lullabell_line_webhook ตรงๆ ต่างกันแค่ channel secret/token + slug คงที่
    (ไม่ใช้ META_SLUG เพราะตัวนั้นเป็นค่า default ของร้านหลัก/lullabell)"""
    body = request.get_data()
    sig = request.headers.get("X-Line-Signature", "")
    if not meta_bot.verify_line_signature(RANGKAFAE_LINE_CHANNEL_SECRET, body, sig):
        return jsonify({"message": "invalid signature"}), 403
    try:
        data = json.loads(body or b"{}")
    except Exception:
    ...
    try:
        client = anthropic.Anthropic(api_key=ANTHROPIC_API_KEY)
        meta_bot.handle_line(data, client, channel_token=RANGKAFAE_LINE_CHANNEL_TOKEN,
                              slug="rangkafae", notify_fn=_push_line,
                              line_user_id=LINE_USER_ID)
    except Exception as e:
        traceback.print_exc()
        print("[rangkafae_line_webhook] error:", str(e)[:200])
    return jsonify({"message": "ok"}), 200
